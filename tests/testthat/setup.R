...
result_08 <- get_measurements(device_id = .get_cumulocity_device_id(), page_size = 7, parse_json = FALSE)
...
result_10 <- get_events(device_id = .get_cumulocity_device_id(), page_size = 3, parse_json = FALSE)
